...
class endocrine_opassess extends Component {
    ...
    handle_marital_status_Change = (event) => {
        ...
        //alert(" After : " + this.state.marital_status)
    ...
    //getmStatus = (data) => {
      //  console.log(" getmStatus Received data : " + data)
    //}
            ...
            <table>
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td><MaritalStatus getmStatus = {mrStatus => this.setState({marital_status: mrStatus}) } /></td>
                      </tr>
                      <tr>
